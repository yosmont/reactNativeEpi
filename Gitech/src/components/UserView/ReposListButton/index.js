...
const ReposListButton = (props) => {
    ...
    return (
        <FullWidthCustomButton /*onPress={() => alert('Repos List Button pressed')}*/ onPress={() => props.navigation.push('Repository', { navigation: props.navigation, octokit: props.octokit, user: props.user })} Text={buttonText} />
    );
}
